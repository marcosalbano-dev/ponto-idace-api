...
import com.idace.pontoidace.api.dtos.CadastroPFDto;
import com.idace.pontoidace.api.entities.Empresa;
...
import com.idace.pontoidace.api.services.EmpresaService;
...
public class CadastroPFController {
	...
	private void validarDadosExistentes(CadastroPFDto cadastroPFDto, BindingResult result) {
		...
		this.funcionarioService.buscarPorSetor(cadastroPFDto.getSetor())
			.ifPresent(func -> result.addError(new ObjectError("funcionario", "Setor já existente.")));
	...
	private Funcionario converterDtoParaFuncionario(CadastroPFDto cadastroPFDto, BindingResult result)
		...
		funcionario.setSetor(cadastroPFDto.getSetor());
	...
	private CadastroPFDto converterCadastroPFDto(Funcionario funcionario) {
		...
		cadastroPFDto.setSetor(funcionario.getSetor());
